...
namespace DAL
{
    public static class AccountDAL
    {
        public static bool Validate(string username,string password)
        {
            ...
            string connStr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\user57\Desktop\DotNetEndModule_Preperation\EndModuleEcommApp1\ECommWebFE\App_Data\ECommDB.mdf;Integrated Security=True";
